...
<head>
  ...
  <style>
    ...
    include("/Schooling/IT/Enviroment/xampp/htdocs/project/makeitman/src/style/adminpage/addproduct.css");
    ?>
  </style>
</head>
...
<body>
  <div class="root">
    <div class="container">
      ...
      <?php
        ...
        include('../Controller/supporter/deploy.php');
        $choice = "";
        if(isset($_POST['show'])) {
          $choice = $_POST['show'];
        }
  ...
  <script>
          ...
          include("/Schooling/IT/Enviroment/xampp/htdocs/project/makeitman/src/action/addaction/showPlus.js");
          ?>
  </script>
