  ...
  <table class="table">
    ...
    <tbody><?php
        ...
        <tr>
          ...
          <td>
            <a href="http://localhost/project/makeitman/app/Views/admin/product/update.php?id=<?php echo $i ?>">
            ...
            <a href="http://localhost/project/makeitman/app/Views/admin/product/delete.php?id=<?php echo $i ?>">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
